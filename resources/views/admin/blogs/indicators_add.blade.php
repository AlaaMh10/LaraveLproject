...
<form method="post" action="{{ route('store.indicator') }}" enctype="multipart/form-data">
        ...
        <select name="blog_category_id" class="form-select" aria-label="Default select example">
            ...
            <option value="{{ $cat->id }}">{{ $cat->indicator_category }}</option>
            @endforeach
            </select>
               </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Indicator Description </label>
                <div class="col-sm-10">
      <textarea class="txt" width="300px" name="blog_description"></textarea>
                </div>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input name="price" class="form-control" type="number" id="example-text-input">
  ...
  <img id="showImage" class="rounded avatar-lg" src="{{ url('upload/no_image.jpg') }}" alt="Card image cap">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Indicator Data">
            </form>
