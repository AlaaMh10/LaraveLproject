...
<div class="col-12">
    <div class="card">
        ...
        <select name="blog_category_id" class="form-select" aria-label="Default select example">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2  col-lg-6 col-form-label">Blog Description </label>
      ...
      {{ $blogs->blog_description }}
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="price" value="{{ $blogs->price }}" class="form-control" type="number" data-role="tagsinput"> 
                </div>
            </div>
