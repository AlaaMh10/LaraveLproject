...
public function BlogDetails($id){
   ...
   $blogs = Blog::findOrFail($id);
   $categories = BlogCategory::orderBy('blog_category','ASC')->limit(3)->get();
...
public function CategoryBlog($id){
 ...
 public function HomeBlog(){
    ...
    $categories = BlogCategory::orderBy('blog_category','ASC')->limit(4)->get();
    $allblogs = Blog::latest()->get();
    $recentblogs = Blog::latest()->limit(4)->get();
    return view('frontend.blog',compact('allblogs','categories','recentblogs'));
